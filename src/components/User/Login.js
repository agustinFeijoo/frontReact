...
const mapDispatchToProps = dispatch => {
    return {
        authenticateUser: (username, password,firstName) => dispatch(authenticateUser(username, password,firstName)) 
        //firstName not needed for authentication but usefull to stope in local vars 
    };
};
